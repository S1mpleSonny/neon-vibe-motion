 ...
 */
export function extractMotion(data) {
    ...
    if (obj.conversation && typeof obj.conversation === 'object') {
        ...
        if (conv.motion && typeof conv.motion === 'object') {
            return { motion: conv.motion, error: null };
        }
...
export function validateMotion(data) {
    ...
    if (!['canvas', 'webgl', 'hybrid'].includes(obj.renderMode)) {
